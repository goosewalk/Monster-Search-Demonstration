...
def loadMap():
   global theMap
   theMapFile = open(os.path.dirname(__file__) + '\\pathfindingmap.txt', 'r')
...
def monsterSearch():
   ...
   if (meCol,meRow) != (monsterCol,monsterRow):
    while len(checkedSquares) > 0:
...
initialScreenSetup()
loadMap()
#'D:\\Programs by me\\CP12\\pathfindingmap.txt'
